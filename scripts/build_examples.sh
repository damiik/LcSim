...
BUILD_DIR="$BUILD_ROOT/build-cpu65c02-wozmon" \
  "$SCRIPT_DIR/build_tool.sh" examples/cpu65c02-wozmon.toml cpu65c02-wozmon
...
Built example tools:
  ...
  $BUILD_ROOT/build-cpu65c02-wozmon/lcsim-gui
